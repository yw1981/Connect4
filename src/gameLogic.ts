...
module gameLogic {
  ...
  export function createComputerMove(board:string[][], turnIndexBeforeMove:number) {
  ...
  export function createMove(board:any, row:number, col:number, turnIndexBeforeMove:number) {
    if (board === undefined) {
    ...
    function getExampleMoves(initialTurnIndex:number, initialState:any, arrayOfRowColComment:any) {
